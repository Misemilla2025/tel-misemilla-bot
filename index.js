...
// === 🧠 Monitor automático de errores Baileys ===
process.on('uncaughtException', err => {
  if (err.message && err.message.includes('stream errored')) {
    console.warn('⚠️ Conexión de WhatsApp interrumpida, reiniciando bot automáticamente...');
    setTimeout(() => {
      iniciarBot().catch(e => console.error('❌ Error al reiniciar tras fallo:', e));
    }, 5000); // espera 5 seg antes de reintentar
  } else {
