...
// === Reinicio automático cada 15 minutos (evita bloqueos o desconexiones) ===
setInterval(() => {
...
// === Auto-Ping al servidor Render cada 5 minutos (evita que se duerma) ===
setInterval(() => {
  fetch('https://bot-whatsapp-misemilla.onrender.com')
    .then(() => console.log('💓 Ping enviado para mantener el bot activo'))
