...
// === Auto-ping cada 4 minutos para evitar hibernación ===
setInterval(() => {
...
// === Servidor Express para mantener el contenedor activo ===
...
// === Monitor de conexión de Baileys (reconexión automática) ===
setInterval(() => {
  try {
...
// === Refuerzo de conexión y manejo de errores no controlados ===
import fs from 'fs';
